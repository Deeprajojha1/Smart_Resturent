...
// Restaurant HeroVisual: Featured specials with real images, responsive, no external deps
const HeroVisual = () => {
  const featured = [
    { img: dosa, name: "Masala Dosa", rating: "4.9" },
    { img: piza, name: "Margherita Pizza", rating: "4.8" },
    { img: indianThali, name: "Indian Thali", rating: "4.7" },
    { img: speacialChiken, name: "Special Chicken", rating: "5.0" }
  ];
  ...
  return (
    <div className="relative">
      ...
      <GlassCard className="relative overflow-hidden p-6">
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-sm font-semibold text-orange-400">Today's Specials</p>
      ...
      <Floating className="absolute -right-4 top-4 rounded-xl bg-gradient-to-r from-amber-500/20 px-3 py-2 text-xs font-medium text-amber-100 shadow-lg border border-amber/30">
        🔥 Today's Top Pick: Dosa!
      </Floating>
    </div>
  );
};
